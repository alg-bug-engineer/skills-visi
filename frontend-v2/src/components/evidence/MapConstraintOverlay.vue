...
<template>
  <div class="map-constraint-card" role="dialog" aria-label="约束量化">
    <header class="card-head">
      <div>
        <span class="eyebrow">治理边界</span>
        <h3>用户约束已量化</h3>
      </div>
      <button type="button" class="dismiss" @click="emit('dismiss')">×</button>
    </header>
...
.map-constraint-card {
  ...
  border: 1px solid rgba(109, 255, 181, 0.4);
