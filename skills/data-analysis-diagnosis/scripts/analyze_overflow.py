    ...
    *,
    ...
    return {
        "metrics": {
            ...
            "queue_statistic": metrics_input.get("queue_statistic"),
            "selected_day_of_week": metrics_input.get("selected_day_of_week"),
            "metric_selection_policy": metrics_input.get("metric_selection_policy"),
            "target_queue_field": metrics_input.get("target_queue_field"),
            "typical_profile_id": metrics_input.get("typical_profile_id"),
            "typical_profile_label": metrics_input.get("typical_profile_label"),
