...
- [ ] `amapUtils`: `fitBoundsForNodes`, `microDollyToApproach`, `lerpPitch`
- [ ] `CameraController` 抽出 + act4/5/7 fitBounds
- [ ] 更新 `camera_movement.md` + `camera.test.ts`
- [ ] act3 `ChannelizationLayer.highlightArm`
